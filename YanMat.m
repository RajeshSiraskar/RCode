...
% # Define
LOADDATA = true;
rEvent = 852000;  % Actual recorded event: 852110
windowPre = 50000;
windowPost = 10;
...
for i = 1:nVars
    ...
    plot(YData(:,i));
    hold on;
    line ([windowPre windowPre], [-2 4], 'LineWidth', 1, 'LineStyle', '-.', 'Color', [0.2 0.4 1.0])
    line ([windowBM windowBM],   [-2 4], 'LineWidth', 1, 'LineStyle', '-.', 'Color', [0.2 0.4 1.0])
